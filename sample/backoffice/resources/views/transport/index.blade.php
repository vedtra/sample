...
<div id="area_datatable">
	<div class="row" style="margin-bottom:10px;">
        <div class="col-md-12">	
            <div class="pull-left">
                <a href="javascript:void(0)" onclick="showForm('{{route('createttransport')}}')" class="btn btn-success"><i class="icon-plus22"></i>Add New</a> 	
            </div>
        </div>
    </div>
...
$(document).ready(function() {  
  function renderActionButton(id){    
    var edit_url = '{{url("transport/edit")}}/'+id;
    var delete_url = '{{url("transport/delete")}}/'+id;
