...
<div id="area_datatable">
	<div class="row" style="margin-bottom:10px;">
        <div class="col-md-12">	
            <div class="pull-left">
                <a href="javascript:void(0)" onclick="showForm('{{route('createcompanycategory')}}')" class="btn btn-success"><i class="icon-plus22"></i>Add New</a> 	
            </div>
        </div>
    </div>
...
$(document).ready(function() {  
  function renderActionButton(id){    
    var edit_url = '{{url("categorycompany/edit")}}/'+id;
    var delete_url = '{{url("categorycompany/delete")}}/'+id;
  ...
  $('#grid').DataTable({    
    ...
    responsive: {
      ...
      "ajax"    : {
              "type"   : "GET",
              "url"    : '{{route("categorycompanyloadjson")}}',
...
function submitForm(){
    var url = '{{route("savecategorycompany")}}';
