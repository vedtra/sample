...
<div id="area_datatable">
	<div class="row" style="margin-bottom:10px;">
        <div class="col-md-12">	
            <div class="pull-left">
                <a href="javascript:void(0)" onclick="showForm('{{route('createcoupon')}}')" class="btn btn-success"><i class="icon-plus22"></i>Add New</a> 	
            </div>
        </div>
    </div>
...
$(document).ready(function() {  
  function renderActionButton(id){    
    var edit_url = '{{url("coupon/edit")}}/'+id;
    var delete_url = '{{url("coupon/delete")}}/'+id;
              ...
              "dataSrc": function (res) {
                ...
                for(var i=0;i< json.length; i++){
                  return_data.push({
                    ...
                    'title'  : json[i].title,
                    'type'  : json[i].type,
                    'min_payment'  : json[i].min_payment,
